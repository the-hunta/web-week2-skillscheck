...
let me = {
    firstName: 'hunter';
    superHeroName: 'hero hunter';
    homeTown: 'salt lake city';
    superPowers: ['time control', 'invisability', 'flight'];
...
let regularName = 'hunter';
let superName = 'hero hunter';
let homeTown = 'salt lake city';
